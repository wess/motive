...
release: clean build ## Build the project in release mode
	@cd ./target/release && \
	tar -czf motive-0.0.3-x86_64-apple-darwin.tar.gz motive && \
	shasum -a 256 motive-0.0.3-x86_64-apple-darwin.tar.gz
